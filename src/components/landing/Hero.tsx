...
const trackedGitHubUrl = withUtmParameters("https://github.com/BhanuPrakash2250", {
  utm_source: "resumelm",
  utm_medium: "referral",
    ...
    <section className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 py-12 md:py-16 lg:py-20">
      ...
      <div className="w-full lg:w-1/2 space-y-8">
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          ...
          <span className="px-3 py-1 rounded-full bg-emerald-50 text-sm border border-emerald-200 text-emerald-700">Free and open source</span>
        ...
        <div className="mt-8">
          <div className="flex items-center p-4 rounded-xl bg-white border border-gray-200 shadow-sm transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">Use your own provider keys or the configured app-funded models.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 relative">
        ...
        <div className="absolute -top-10 -right-6 w-[40%] aspect-[3/4] rounded-xl bg-white border border-gray-200 shadow-md overflow-hidden rotate-[8deg] z-10 transition-all duration-300 hover:rotate-[4deg]">
          ...
          <div className="s bottom-2 right-2 px-1.5 py-0.5 rounded bg-teal-50 border border-teal-200 text-[8px] text-teal-700">
            Technical
          </div>
        </div>
      </div>
