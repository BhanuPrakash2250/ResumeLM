...
const trackedCreatorXUrl = withUtmParameters("https://x.com/alexfromvan", {
  utm_source: "resumelm",
  utm_medium: "social",
  utm_campaign: "creator-story",
});
const trackedCreatorGitHubUrl = withUtmParameters("https://github.com/BhanuPrakash2250", {
  utm_source: "resumelm",
  utm_medium: "referral",
  utm_campaign: "creator-story",
});
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-violet-600">
            Bhanu Prakash, Developer & Creator of ResumeLM
          </h2>
        </motion.div>
        ...
        >
          ...
          >
            <div className="relative aspect-square w-64 md:w-96 rounded-2xl overflow-hidden bg-white border border-gray-200 shadow-md transform transition-all duration-300 hover:-translate-y-2">
              <Image
                src="/Bhanu.png"
                alt="Bhanu Prakash, creator of ResumeLM"
                fill
