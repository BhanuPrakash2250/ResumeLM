...
export function FAQ() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "Yes. ResumeLM is free to use, supports your own provider keys, and can be self-hosted."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. You can use your own OpenAI, Anthropic, or other AI provider API keys while accessing all of ResumeLM's features."
    },
    {
      question: "Is my data secure and private?",
      answer: "Resume data is stored in the configured Supabase project, product analytics are handled by PostHog, and provider keys stay in this browser's local storage."
    },
    {
