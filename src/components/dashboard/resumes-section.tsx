      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <span className={cn(
            ...
            Create another {type === 'base' ? 'base' : 'tailored'} resume
          </span>
          <span className={cn(
            "mt-2 text-xs",
            "text-amber-600/70",
              ...
              <div className="absolute bottom-2 left-2 flex gap-2">
                ...
                {canCreateMore ? (
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Resume creation paused</AlertDialogTitle>
                        <AlertDialogDescription>
                          Resume creation is temporarily unavailable. Check your provider settings and try again.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction asChild>
                          <Link href="/settings" prefetch={false} className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white hover:from-teal-700 hover:to-cyan-700">
                            Open Settings
                          </Link>
                        </AlertDialogAction>
                      </AlertDialogFooter>
