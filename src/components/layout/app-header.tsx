            ...
            <>
              ...
              <nav className="hidden md:flex items-center gap-1 lg:gap-2">
                ...
                <div className="flex items-center px-2 lg:px-3 py-1">
                  ...
                  <Link href="/settings" className="text-sm font-medium text-purple-600/80 hover:text-purple-800">Settings</Link>
                </div>
              </nav>
              ...
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent side="right" className="w-[280px] sm:w-[320px]">
                  ...
                  <div className="flex flex-col gap-4 pt-6">
                    ...
                    <div className="px-4">
                      <Link href="/settings" className="flex w-full items-center justify-start rounded-md px-3 py-2 text-sm font-medium text-purple-600/80 hover:text-purple-800 hover:bg-purple-50" onClick={() => setIsOpen(false)}>
                        Settings
                      </Link>
                    </div>
                  </div>
