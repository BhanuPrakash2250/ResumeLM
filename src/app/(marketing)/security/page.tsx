...
export default function SecurityPage() {
  return (
    <LegalPage title="Security" updated="August 1, 2026">
      ...
      <p>
        ResumeLM uses Supabase authentication and row-level access controls for application data. Provider secrets are kept in server environment variables rather than sent to the browser.
      </p>
