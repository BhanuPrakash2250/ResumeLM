...
CREATE TABLE IF NOT EXISTS public.jobs (
  ...
  CONSTRAINT jobs_ownership_check CHECK (user_id IS NOT NULL OR anonymous_session_id IS NOT NULL)
...
CREATE TABLE IF NOT EXISTS public.resumes (
  ...
  CONSTRAINT resumes_ownership_check CHECK (user_id IS NOT NULL OR anonymous_session_id IS NOT NULL),
